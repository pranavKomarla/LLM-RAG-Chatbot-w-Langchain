...
The final application is the code provided in `source_code_final/`.
...
Once you have a running Neo4j instance, and have filled out all the environment variables in `.env`, you can run the entire project with [Docker Compose]
